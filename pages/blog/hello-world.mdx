...
version control (git), and, most importantly, (3) incorporate {<em title="This string came from rust -> wasm!" className="text-orange-600"><RustString></RustString></em>}
...
(to get this working on vercel I had to add `amazon-linux-extras install rust1` to my build command, but this was a very old version of rust :broken heart:)
